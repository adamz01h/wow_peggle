...
e.sounds = {"applause.ogg", "blank.ogg", "ball_add.ogg", "blank.ogg", "cannonshot.ogg", "coin_spin.ogg", "coin_freeball_denied.ogg", "extraball.ogg", "extraball2.ogg", "extraball3.ogg", "extremefever2.ogg", "feverhit.ogg", "blank.ogg", "fireworks2.ogg", "gapbonus1.ogg", "gong.ogg", "odetojoy.ogg", "peghit", "pegpop.ogg", "", "aah.ogg", "powerup_guide.ogg", "powerup_spaceblast.ogg", "rainbow.ogg", "scorecounter.ogg", "sigh.ogg", "timpaniroll.ogg", "xbump_mod2.ogg", "aah.ogg", };
e.SOUND_APPLAUSE = 1;
e.SOUND_AWARD = 2;
e.SOUND_BALL_ADD = 3;
